...
println("Monthly summarized data for 2023:")
println(df_monthly_2023)
...
# Visualize the actual data for 2015-2022
plot(1:time, X_data_combined, label="Actual Data 2015-2022", linewidth=2, title="Actual Data 2015-2022")

# Visualize the actual data for 2023
plot(1:12, X_data_2023, label="Actual Data 2023", linewidth=2, color=:blue, title="Actual Data 2023")

# Visualize the predictions vs actual data
ts_fcst = (time+1):(time + time_fcst)
p = plot(1:time, X_data_combined, label="Actual Data 2015-2022", linewidth=2, title="Predictions vs Actual Data 2023")
