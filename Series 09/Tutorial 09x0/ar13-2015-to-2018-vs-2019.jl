...
# Combine 2015, 2016, 2017, and 2018 data
df_combined = vcat(df_monthly_2015, df_monthly_2016, df_monthly_2017, df_monthly_2018)

# Extract 'FREE_ON_BOARD_SUM' values
X_data_combined = df_combined[!, :FREE_ON_BOARD_SUM]
X_data_2019 = df_monthly_2019[!, :FREE_ON_BOARD_SUM]
...
# Make predictions for 2019 based on 2015-2018 data
...
# Visualize the actual data for 2015-2018
plot(1:time, X_data_combined, label="Actual Data 2015-2018", linewidth=2, title="Actual Data 2015-2018")

# Visualize the actual data for 2019
plot(1:12, X_data_2019, label="Actual Data 2019", linewidth=2, color=:blue, title="Actual Data 2019")

# Visualize the predictions vs actual data
ts_fcst = (time+1):(time + time_fcst)
p = plot(1:time, X_data_combined, label="Actual Data 2015-2018", linewidth=2, title="Predictions vs Actual Data 2019")
plot!(p, ts_fcst, X_data_2019, label="Actual Data 2019", linewidth=2, color=:blue)
